...
《C++标准库》的作者 Nicolai M.Josuttis 的几本C++教程都挺好的，可惜只有关于C++11的这本书被侯捷翻译过来。《[C++ Move Semantics, the complete guide](https://www.cppmove.com/)》英文原版涵盖了从C++11到C++20的移动语义，我读的版本是2020-12-19的电子版，读后收益良多。这里本想写的是读书笔记，但是看上去大部分还是按照原文翻译的，英文功底有限，技术上的语言上的都欢迎指正（拉到最底下有评论区）。
